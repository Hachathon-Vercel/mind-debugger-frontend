            ...
            <div className="chat-container-wrapper">
                <div className="chat-container bg-darkBackground p-4 rounded-md shadow-md w-full">
                    ...
                    <div className="input-container mt-4 flex items-center">
                        <input type="text" placeholder="Escribe un mensaje ..." className="flex-grow p-2 rounded-md bg-inputBackground" />
                        <button className="ml-2 p-2 text-white flex items-center justify-center hover-icon">
